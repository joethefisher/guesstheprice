  ...
  theme: {
    extend: {
      colors: {
        ...
        paper: "#F7F4EE",
        "paper-strong": "rgba(247,244,238,0.95)",
        "paper-default": "rgba(247,244,238,0.80)",
        "paper-mute": "rgba(247,244,238,0.60)",
        "paper-quiet": "rgba(247,244,238,0.40)",
        cream: "#EDE6D6",
        accent: "#FF5C39",
        "accent-deep": "#E84A28",
        moss: "#4A6741",
      ...
      fontSize: {
        // 10-step type scale. Components MUST snap inline fontSize to one of these.
        ...
        "3xl": ["44px", { lineHeight: "1.05", letterSpacing: "-0.02em" }],
