...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundColor: {
        "paper-95": "rgba(247,244,238,0.95)",
        "paper-80": "rgba(247,244,238,0.80)",
        "paper-60": "rgba(247,244,238,0.60)",
        "paper-40": "rgba(247,244,238,0.40)",
        "paper-15": "rgba(247,244,238,0.15)",
        "paper-08": "rgba(247,244,238,0.08)",
      ...
      borderColor: {
        "paper-20": "rgba(247,244,238,0.20)",
        "ink-12": "rgba(26,26,26,0.12)",
      ...
      boxShadow: {
        ...
        card: "0 1px 0 rgba(26,26,26,0.12), 0 8px 24px -16px rgba(0,0,0,0.18)",
        "icon-sm": "0 4px 12px rgba(0,0,0,0.18)",
        "icon-inset": "inset 0 0 0 1px rgba(255,255,255,0.18)",
        "focus-ring": "0 0 0 3px var(--ink), 0 0 0 5px rgba(0,0,0,0.1)",
      },
